...
$packageName= 'typescript-vs2015' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://download.microsoft.com/download/6/D/8/6D8381B0-03C1-4BD2-AE65-30FF0A4C62DA/TS1.7.6-D14OOB.24809.00/TypeScript_Full.exe' # download url
...
$packageArgs = @{
  ...
  softwareName  = 'TypeScript Tools for Microsoft Visual Studio 1.7.6.0' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
